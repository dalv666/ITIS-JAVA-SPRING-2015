...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task1/ObjectFactory.java)
###### Задание№2
...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task2/)
###### Задание№3
<ul>
...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task3/)
###### Задание№4
<ul>
...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task4/)

###### Задание№5
<ul>
<li>Напишите свой <code>BeanPostProcessor</code>, который будет запускать методы аннотированные <code>@RunThisMethod</code></li>
</ul>
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task5/)
###### Задание№6
<ul>
...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task6/)
###### Задание№7
<ul>
<li>Пишем прокси, который будет замерять время вызова метода</li>
</ul>
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task7/)
###### Задание№8
<ul>
<li>Benchmark, который будет замерять время вызова метода с помощью dynamic proxy</li>
</ul>
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task8/)
###### Задание№9
<ul>
...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task9/)
###### Задание№10
<ul>
...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task10/)
###### Задание№11
<ul>
...
#######Исходники: [main](/src/main/java/su/dalv/itis/java/spring/task11/)
