...
<li>Создайте <code>controller</code> для <code>/hello</code></li>
<li>Верните <code>jsp</code></li>
<li>Попробуйте всякие другие маппирования</li>

<li>Добавляем контроллер посложнее, который принимает параметр в <code>URL</code> и показывает его обратно пользователю</li>
<li>Также, печатает все <code>header-ы</code></li>
